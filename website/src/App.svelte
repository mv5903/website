            ...
            <div class="absolute top-0 w-[100%] max-w-[1600px]">
              <div class="navbar">
                ...
                <div class="flex-1">
                  ...
                  <div class="tooltip tooltip-bottom" data-tip="What does this do?" on:click={() => window.location.href = "https://mattvandenberg.com/mystery.html"} >
      ...
      <section id="work" class="px-4 py-8 w-full sm:w-1/2 text-center">
        <div class="flex justify-center place-items-center gap-3">
          ...
          {#if closedInfoCards.some(id => id.startsWith("W"))}
            <button class="btn btn-sm animate-ping" on:click={() => closedInfoCards = closedInfoCards.filter(id => !id.startsWith("W"))}>
              <span>Reset</span>
            </button>
          {/if}
        </div>
      ...
      <section id="education" class="px-4 py-8 w-full sm:w-1/2 text-center">
        <div class="flex justify-center place-items-center gap-3">
          ...
          {#if closedInfoCards.some(id => id.startsWith("S"))}
            <button class="btn btn-sm animate-ping" on:click={() => closedInfoCards = closedInfoCards.filter(id => !id.startsWith("S"))}>
              <span>Reset</span>
            </button>
          {/if}
        </div>
    ...
    <section id="projects" class="px-4 py-8 text-center">
      <div class="flex justify-center place-items-center gap-3">
        ...
        {#if closedInfoCards.some(id => id.startsWith("P"))}
          <button class="btn btn-sm animate-ping" on:click={() => closedInfoCards = closedInfoCards.filter(id => !id.startsWith("P"))}>
            <span>Reset</span>
          </button>
        {/if}
      </div>
