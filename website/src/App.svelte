      ...
      <div class="flex justify-center mt-4">
        <ol class="relative border-s border-gray-700">
          ...
          <li class="mb-10 ms-4">
            ...
            <a href={`http://home.mattvandenberg.com:3000/blog/${blog.blog}`} target="_blank" class="inline-flex items-center px-4 py-2 text-sm font-medium  border  rounded-lg focus:z-10 focus:ring-4 focus:outline-none bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 focus:ring-gray-700">Read <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
