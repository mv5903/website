...
class __TwigTemplate_b4f3577357c392a0845ad1c93f110b348e752f2410da557f0995634c017240ca extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <fieldset>
      <legend>
        ...
        ";
            // line 8
            echo sprintf(_gettext("Users having access to \"%s\""), ((((((("<a href=\"" . ($context["table_url"] ?? null)) . PhpMyAdmin\Url::getCommon(["db" =>             // line 9
...
";
    ...
    {
        return new Source("", "table/privileges/index.twig", "/home/matt/site/phpmyadmin/templates/table/privileges/index.twig");
    }
}
