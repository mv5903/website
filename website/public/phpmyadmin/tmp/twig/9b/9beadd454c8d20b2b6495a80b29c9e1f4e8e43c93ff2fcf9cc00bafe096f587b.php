...
class __TwigTemplate_ef318db89f31539b4ddf834150ad85fc04b04fe1f611e94dff50888ba53a6d5e extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        if ( !($context["has_config_storage"] ?? null)) {
            ...
            // line 59
            echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [sprintf($___internal_df931ea307bbcbfe8877a078f24d146e11ac1f8287fb6883540c2e152a560d08_, (("<a href=\"" . \PhpMyAdmin\Html\MySQLDocumentation::getDocumentationLink("setup", "linked-tables")) . "\" target=\"_blank\" rel=\"noopener noreferrer\">"), "</a>")]);
            // line 62
            echo "  ";
        }
    }
    ...
    {
        return new Source("", "preferences/header.twig", "/home/matt/site/phpmyadmin/templates/preferences/header.twig");
    }
}
